...
impl NodeManager {
    ...
    async fn register_with_gcs(
        ...
        let node_info = rpc::GcsNodeInfo {
            ...
            node_manager_hostname: self.config.node_ip_address.clone(),
            raylet_socket_name: self.config.raylet_socket.clone(),
            node_manager_port: bound_port as i32,
            object_manager_port: self.config.object_manager_port as i32,
            metrics_export_port: self.config.metrics_export_port as i32,
            runtime_env_agent_port: self.config.runtime_env_agent_port as i32,
            metrics_agent_port: self.config.metrics_agent_port as i32,
